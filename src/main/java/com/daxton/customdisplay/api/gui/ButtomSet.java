...
//        Map<String, String> player_Item_Action_Map = SetActionMap.setClassAction(content);
    ...
    //基礎按鈕設定
    public static ItemStack getItemButtom2(String buttomPath, int order, String addValue){
        ...
        if(buttomDisplayName != null){
            im.setDisplayName(buttomDisplayName.replace("{value}",String.valueOf(order+1)));
        }
