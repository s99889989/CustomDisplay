...
public class LocLight {

    public static void setLight(LivingEntity self, LivingEntity target, Map<String, String> action_Map, String taskID, Location inputLocation){
