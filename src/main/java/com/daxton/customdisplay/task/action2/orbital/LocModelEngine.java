...
public class LocModelEngine {
    ...
    public void setGuise(LivingEntity self, LivingEntity target, Map<String, String> action_Map, String taskID, Location location){
        this.taskID = taskID;
        this.self = self;
        this.target = target;
...
//        Location oldlocation = inputlocation;
...
//        if(target != null){
//            cd.getLogger().info(target.getName());
//        }
