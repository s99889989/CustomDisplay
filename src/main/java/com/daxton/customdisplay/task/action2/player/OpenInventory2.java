...
public class OpenInventory2 {
    ...
    public void openInventory(Player player,int amount,String message,String taskID){
        ...
        if(ActionManager2.taskID_Inventory_Map.get(taskID) == null){
            ActionManager2.taskID_Inventory_Map.put(taskID, Bukkit.createInventory(null, amount , message));
            ActionManager2.playerUUID_taskID_Map.put(player.getUniqueId().toString(),taskID);
        }
        if(ActionManager2.taskID_Inventory_Map.get(taskID) != null){
            Inventory inventory = ActionManager2.taskID_Inventory_Map.get(taskID);
