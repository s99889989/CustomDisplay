...
public class SetClassAttr {
    ...
    public static void set(LivingEntity self, LivingEntity target, Map<String, String> action_Map, String taskID){
        ...
        livingEntityList.forEach(livingEntity -> {
            ...
            //量
            String amount = actionMapHandle2.getString(new String[]{"amount","a"},"1");
            giveAttr(livingEntity,attributes, label,type,amount,duration);
        });
...
//                    player.sendMessage(attributes+" : "+label+" : "+amount);
