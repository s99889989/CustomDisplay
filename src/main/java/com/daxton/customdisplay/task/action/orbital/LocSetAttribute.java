...
public class LocSetAttribute {

    CustomDisplay cd = CustomDisplay.getCustomDisplay();

    public LocSetAttribute(){
...
//        }
        ...
        if(target != null){
            giveNotPlayerAttr(target, attributes, label, type, amount, duration);
        }
    ...
    public void giveNotPlayerAttr(LivingEntity livingEntity, String attributes, String label, String type , Double amount, int duration){
        ...
        if(ActionManager.setAttribute_Run_Map.get(uuidString+attributes) == null){
            ...
            setNotPlayerAttr(livingEntity, type, attributes, amount, label, duration);
    ...
    public void setNotPlayerAttr(LivingEntity livingEntity, String type, String attributes, Double amount, String label, int duration){
        String uuidString = livingEntity.getUniqueId().toString();


        new PlayerBukkitAttribute().addAttribute(livingEntity,attributes.toUpperCase(),"ADD_NUMBER",amount,label);
        ...
        if(duration > 0){
            ActionManager.setAttribute_Run_Map.put(uuidString + attributes, new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    new PlayerBukkitAttribute().removeAttribute(livingEntity, attributes.toUpperCase());
